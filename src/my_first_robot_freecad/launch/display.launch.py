...
def generate_launch_description():
    pkg_share = Path(launch_ros.substitutions.FindPackageShare(package='my_first_robot_freecad').find('my_first_robot_freecad'))
    default_model_path = pkg_share / 'urdf/FirstRobot.urdf'
    ...
    robot_state_publisher_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            PathJoinSubstitution([
                FindPackageShare('my_first_robot_freecad'),
                'launch',
