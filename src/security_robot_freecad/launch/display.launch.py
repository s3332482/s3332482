...
def generate_launch_description():
    pkg_share = Path(launch_ros.substitutions.FindPackageShare(package='security_robot_freecad').find('security_robot_freecad'))
    ...
    robot_state_publisher_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            PathJoinSubstitution([
                FindPackageShare('security_robot_freecad'),
                'launch',
